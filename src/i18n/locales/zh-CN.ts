...
export default {
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "visualizer-cielo": { "title": "可视化：天际", "description": "切换到天际可视化" },
  ...
  "options": {
    ...
    "fumeHeroScale": "大标题比例",
    "cieloSettings": "天际参数",
    "cieloSettingsDesc": "控制着色器推镜速度、几何与粒子密度。",
    "cieloCameraSpeed": "摄影机移动速度",
    "cieloGeometricDensity": "几何图形密度",
    "cieloParticleDensity": "碎片粒子密度",
    "cieloBaseColorMix": "基础色调混合比",

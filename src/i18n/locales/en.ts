...
export default {
  ...
  "commandPalette": {
    ...
    "commands": {
      ...
      "visualizer-cielo": { "title": "Visualizer: Cielo", "description": "Switch to cielo visualizer" },
  ...
  "options": {
    ...
    "cieloSettings": "Cielo Tuning",
    "cieloSettingsDesc": "Control shader camera speed, geometry, and particle density.",
    "cieloCameraSpeed": "Camera Speed",
    "cieloGeometricDensity": "Geometry Density",
    "cieloParticleDensity": "Particle Density",
    "cieloBaseColorMix": "Base Color Mix Ratio",
